...
replay.speed(1000)
replay.goto(1000,1000)
replayback = turtle.Turtle()
replayback.shape('circle')
replayback.color('moccasin')
replayback.shapesize(3)
replayback.penup()
replayback.speed(1000)
replayback.goto(1000,1000)
...
surrenderback = turtle.Turtle()
surrenderback.penup()
surrenderback.shape('circle')
surrenderback.color('maroon')
surrenderback.speed(10000)
surrenderback.shapesize(3)
surrenderback.goto(245,230)
...
confirmback = turtle.Turtle()
confirmback.speed(1111)
confirmback.shape('circle')
confirmback.color('burlywood4')
confirmback.shapesize(3)
confirmback.penup()
confirmback.goto(140,230)
#THIS FUNCTION JUST BELOW IT CALLS FOR THE MAIN ENGINE THAT CHECKS THE CODE
confirm.onclick(confirmation)
####ABOVE FUNCTION WORKS FOR ALL THE TIME WHILE THE SCREEN IS OPEN
loading.clear()
loading.write(load[2],align="left",font=("candara",15,"bold"))
loading.clear()
#THIS WAS LEFT AND I COULD NOT FIND THE CORRECT PLACE TO PUT IT

#LISTENING TO KEYS
wn.listen()
wn.onkeypress(got11,"1")
wn.onkeypress(got22,"2")
wn.onkeypress(got33,"3")
wn.onkeypress(got44,"4")
wn.onkeypress(got55,"5")
wn.onkeypress(got66,"6")
wn.onkeypress(got77,"7")
wn.onkeypress(got88,"8")
wn.onkeypress(confirmations,"Return")
wn.onkeypress(surrenderings,"Escape")
turtle.done()
