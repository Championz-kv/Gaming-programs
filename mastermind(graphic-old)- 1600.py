...
lavapede.speed(1000)
lavapede.hideturtle()
garados = turtle.Turtle()
garados.penup()
garados.shape('square')
garados.shapesize(20)
garados.hideturtle()
garados.speed(1000)
garados.goto(1000,1000)
jynx = turtle.Turtle()
...
surrender.penup()
surrender.shape('square')
surrender.color('maroon')
surrender.speed(10000)
surrender.shapesize(3)
